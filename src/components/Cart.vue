<template>
  <div class="cart-container p-4 mx-auto max-w-screen-lg">
    ...
    <div v-else class="overflow-x-auto">
      <table
        class="w-full table-auto text-sm text-left rtl:text-left text-gray-500 dark:text-gray-400"
      >
        <thead
        ...
        <tbody>
          ...
          >
            <th
              scope="row"
              class="px-2 py-4 sm:px-4 sm:py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
            >
              {{ item.title }}
            </th>
            ...
            <td class="px-2 py-4 sm:px-4 sm:py-4">
              <div class="flex items-center space-x-2">
                <button
                  ...
                  class="bg-gray-300 text-black py-1 px-2 rounded-lg hover:bg-gray-400 transition-colors"
                >
                  -
                </button>
            ...
            <td class="px-2 py-4 sm:px-4 sm:py-4">
              ...
              <button
                ...
                class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors mt-2"
              >
                Compare
              </button>
            </td>
      ...
      <div class="mt-8 bg-gray-100 p-4 rounded-lg shadow-md">
        ...
        <button
          @click="clearCart"
          class="mt-4 bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors"
        >
          Clear Cart
        </button>
      </div>
